...
class CameraPlugin : public flutter::Plugin,
 ...
 public:
  ...
  // Handles calls on the preview frame polling channel
  // (currently only getPreviewFrame, which returns the latest preview
  // sample of a camera without going through a still capture).
  void HandlePreviewFrameMethodCall(
